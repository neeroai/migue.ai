 ...
 * @description TypeScript definitions for Supabase database schema (auto-generated by Supabase CLI - do not edit manually)
 * @module lib/database.types
 * @exports Json, Database, Tables, TablesInsert, TablesUpdate, Enums, CompositeTypes, Constants
 * @runtime edge
 * @date 2026-02-07 19:19
 * @updated 2026-02-07 19:19
 */
