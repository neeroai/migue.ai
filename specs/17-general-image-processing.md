...
- Owner técnico: `src/modules/ai/application/vision-pipeline.ts`

## Objetivo funcional
Procesamiento general de imágenes/documentos con confirmación para side effects inferidos.
