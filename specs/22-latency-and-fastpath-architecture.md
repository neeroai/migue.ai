# 22 - latency-and-fastpath-architecture
...
- Owner técnico: `src/modules/webhook/* + src/modules/ai/*`

## Objetivo funcional
Arquitectura de baja latencia por pathway con SLO medibles y degradación controlada.
