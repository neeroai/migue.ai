...
- Owner técnico: `src/modules/agent/infra/*`

## Objetivo funcional
Ledger durable de eventos/runs/steps/tool-calls/checkpoints para auditoría y reintentos.
